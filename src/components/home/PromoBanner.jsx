...
const PromoBanner = () => {
  ...
  // Use single full-width banner or split into 2
          ...
          >
            <Link to={banner.link} className="group block relative overflow-hidden rounded-xl">
              <img
                src={banner.image}
                alt={banner.subtitle}
                className="w-full h-[200px] sm:h-[280px] lg:h-[350px] object-cover transition-transform duration-500 group-hover:scale-[1.02]"
              />
              <div className="absolute inset-0 bg-gradient-to-r from-primary/80 via-primary/40 to-transparent flex items-center">
                <div className="px-8 sm:px-12 lg:px-16">
                  <p className="text-white/80 font-button text-xs sm:text-sm uppercase tracking-wider mb-1">
                    {banner.title}
                  </p>
                  <h3 className="font-heading text-xl sm:text-3xl lg:text-4xl text-white font-bold mb-2">
                    {banner.subtitle}
                  </h3>
            ...
            >
              <Link to={banner.link} className="group block relative overflow-hidden rounded-xl">
                <img
                  src={banner.image}
                  alt={banner.subtitle}
                  className="w-full h-[180px] sm:h-[220px] lg:h-[280px] object-cover transition-transform duration-500 group-hover:scale-[1.02]"
                />
                <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/20 to-transparent flex items-end">
                  <div className="p-5 sm:p-6">
                    <p className="text-white/70 font-button text-[10px] sm:text-xs uppercase tracking-wider mb-1">
                      {banner.title}
                    </p>
                    <h3 className="font-heading text-lg sm:text-xl lg:text-2xl text-white font-bold mb-2">
                      {banner.subtitle}
                    </h3>
